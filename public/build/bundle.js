    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 41, 2, 908);
    			attr_dev(input1, "placeholder", "What needs to be done?");
    			add_location(input1, file, 42, 2, 958);
    			add_location(div, file, 40, 1, 899);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*todos*/ 2 && input1.value !== /*todo*/ ctx[8].text) {
    				set_input_value(input1, /*todo*/ ctx[8].text);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:1) {#each todos as todo}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 37, 1, 752);
    			add_location(button0, file, 37, 39, 790);
    			add_location(button1, file, 37, 75, 826);
    			add_location(main, file, 36, 0, 743);
    		},
